...
isol_test = pd.read_csv('data/a4/test_data/isolated_test_y.csv', index_col='id')
cont_test = pd.read_csv('data/a4/test_data/contextual_test_y.csv', index_col='id')
...
if len(leaderboards) != 0:
    ...
    for name, board in leaderboards.groupby("leaderboard"):
        ...
        commit_message = "A4 Leaderboard Update"
